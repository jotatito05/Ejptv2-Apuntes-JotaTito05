...
- [Parte 1: Fundamentos Teóricos](#parte-1-fundamentos-teóricos)
  ...
  - [1.3 Resum y Recursos](#13-resumen-y-recursos)
- [Parte 2: Reconocimiento y Enumeración](#parte-2-reconocimiento-y-enumeración)
  ...
  - [2.4 Resum y Recursos](#24-resumen-y-recursos)
- [Parte 3: Técnicas de Explotación](#parte-3-técnicas-de-explotación)
  ...
  - [3.4 Resum y Recursos](#34-resumen-y-recursos)
- [Parte 4: Post-Explotación y Escalado de Privilegios](#parte-4-post-explotación-y-escalado-de-privilegios)
  ...
  - [4.5 Resum y Recursos](#45-resumen-y-recursos)
- [Parte 5: Referencia de Eines](#parte-5-referencia-de-herramientas)
  - [5.1 Eines de Escaneo](#51-herramientas-de-escaneo)
  - [5.2 Eines de Fuerza Bruta](#52-herramientas-de-fuerza-bruta)
  - [5.3 Eines de Red](#53-herramientas-de-red)
  - [5.4 Resum y Recursos](#54-resumen-y-recursos)
...
Soc en **jotatito05** i aquests són els apunts que he creat durant la meva preparació per a l'examen eLearnSecurity Junior Penetration Tester versión 2 (eJPTv2). He decidit compartir-los **voluntària i gratuïtament** amb la comunitat perquè crec fermament que el coneixement en ciberseguretat ha de ser accessible per a tothom.
...
- **Fonaments teòrics sòlids**: Conceptos de redes, protocolos y sistemas operativos
- **Tècniques pràctiques**: Reconocimiento, enumeración, explotación y post-explotación
- **Eines essencials**: Guías detalladas de las herramientas más importantes
- **Exercicis complets**: Escenarios paso a paso para practicar
- **Consells per a l'examen**: Estrategias, trucos y errores comunes a evitar
- **Recursos addicionals**: Enlaces a documentación, plataformas de práctica y comunidades
...
> **⚠️ Advertència**: Estos cuadros señalan precauciones importantes

> **💡 Consell**: Estos cuadros ofrecen trucos y mejores prácticas
...
- **Eines**: La mayoría vienen preinstaladas en Kali Linux

> **💡 Consell**: Si no puedes instalar Linux, puedes usar Windows con WSL2 (Windows Subsystem for Linux) o una máquina virtual.
...
Estàs llest per començar el teu viatge hacia la certificación eJPTv2! Recorda: cada expert va ser una vegada un principiant. Con dedicación y práctica, tú también puedes lograrlo.
...
| Capa | Nombre | Función | Exemples | Relevancia para Pentesting |
|------|--------|---------|----------|---------------------------|
...
## Part 2: Reconeixement i Enumeració
...
**Comandes esenciales de Metasploit**:
...
## Part 4: Post-Explotació i Escalada de Privilegis
...
#### Eines de Enumeración Automatizada
...
## Part 5: Referència d'Eines

### 5.1 Eines de Escaneo
...
### 5.4 Resum y Recursos

**Eines essencials para eJPTv2**:
- ✅ Nmap (escaneo)
- ✅ Gobuster (web enum)
- ✅ Hydra (brute force)
...
## Part 6: Màquines de Hack The Box (Laboratori)
...
> **💡 Consell:** No uses Metasploit para todas. Intenta explotarlas manualmente primero para entender qué está pasando. El examen eJPTv2 permite Metasploit, pero saber hacerlo a mano te salvará si falla.

### 6.4 Resum y Recursos
...
- **Nota:** Algunas máquinas requieren suscripción VIP para acceder si están retiradas. Las de "Starting Point" son siempre gratuitas.

[⬆️ Volver al inicio](#tabla-de-contenidos)

---

## Part 7: Preparació per a l'Examen
...
| Puerto | Servicio | Descripción | Comandes de Enumeración |
|--------|----------|-------------|------------------------|
